      ...
      <div className="home-strip" style={{paddingTop:0, borderTop:'none'}}>
        <div className="container">
          ...
          <div className="system-cards">
            <div className="system-card glass reveal rd1" role="button" tabIndex={0} aria-label="Open SyntheX Prime case study" onClick={() => onNavigate('synthex')} onKeyDown={e => e.key==='Enter'&&onNavigate('synthex')}>
              <span className="sc-tag green">Automation Platform</span>
              <div className="sc-name">SyntheX Prime</div>
              <div className="sc-tagline">A 500+ command Discord automation platform that started as a monolith. Rebuilding it taught me what modular architecture actually means at scale.</div>
              <div className="sc-props">
                <div className="sc-prop">Modules self-register at startup so the dispatcher never needs to know what commands exist</div>
                <div className="sc-prop">Each command category runs in its own isolated module with no cross-module state</div>
                <div className="sc-prop">Long-running async pipelines never block the main command loop</div>
              </div>
