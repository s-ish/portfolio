      ...
      <div className="container page-wrap">
        ...
        <div className="contact-grid">
          <div className="reveal">
            <a href="https://github.com/si-sh" target="_blank" rel="noopener noreferrer" className="contact-item glass">
              ...
              <div><div className="ci-type">GitHub</div><div className="ci-val">github.com/si-sh</div></div>
            </a>
            ...
            <a href="mailto:contact@si-sh.dev" className="contact-item glass">
              ...
              <div><div className="ci-type">Email</div><div className="ci-val">contact@si-sh.dev</div></div>
            </a>
          </div>
